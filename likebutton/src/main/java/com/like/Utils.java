...
public class Utils
{
    ...
    public static List<Icon> getIcons()
    {
        ...
        icons.add(new Icon(R.drawable.star_filled, R.drawable.star, IconType.Star_EventFULL ));
        icons.add(new Icon(R.drawable.star_filled, R.drawable.star_alternate, IconType.Star_Alternate ));
